...
class TestKeeperGoalsAdded(unittest.TestCase):
    def setUp(self):
        ...
        self.expected_player_data = {
            ...
            "passing_goals_added_above_avg": -0.31,
            "passing_count_actions": 739,
            "shotstopping_goals_added_raw": -1.38,
            "shotstopping_goals_added_above_avg": -1.08,
            ...
            "avg_fielding_goals_added_above_avg": 0.01,
            ...
            "avg_passing_goals_added_above_avg": -0.14,
            "avg_passing_count_actions": 582.2,
            "avg_shotstopping_goals_added_raw": -0.47,
            "avg_shotstopping_goals_added_above_avg": -0.22,
            ...
            "min_shotstopping_goals_added_above_avg": -7.19,
            ...
            "max_claiming_goals_added_above_avg": 0.25,
            "max_claiming_count_actions": 42,
            "max_fielding_goals_added_raw": 0.08,
            "max_fielding_goals_added_above_avg": 0.17,
            ...
            "max_passing_goals_added_above_avg": 0.78,
            "max_passing_count_actions": 1047,
            "max_shotstopping_goals_added_raw": 5.39,
            "max_shotstopping_goals_added_above_avg": 5.72,
