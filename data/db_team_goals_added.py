...
def insert_team_goals_added_by_season(season):
    ...
    for team in teams_data:
        ...
        ''', (
            ...
            actions['Dribbling']['num_actions_for'],
            actions['Dribbling']['goals_added_for'],
            actions['Dribbling']['num_actions_against'],
            actions['Dribbling']['goals_added_against'],
            actions['Shooting']['num_actions_for'],
            actions['Shooting']['goals_added_for'],
            actions['Shooting']['num_actions_against'],
            actions['Shooting']['goals_added_against'],
            actions['Passing']['num_actions_for'],
            actions['Passing']['goals_added_for'],
            actions['Passing']['num_actions_against'],
            actions['Passing']['goals_added_against'],
            actions['Interrupting']['num_actions_for'],
            actions['Interrupting']['goals_added_for'],
            actions['Interrupting']['num_actions_against'],
            actions['Interrupting']['goals_added_against'],
            actions['Receiving']['num_actions_for'],
            actions['Receiving']['goals_added_for'],
            actions['Receiving']['num_actions_against'],
            actions['Receiving']['goals_added_against'],
            actions['Claiming']['num_actions_for'],
            actions['Claiming']['goals_added_for'],
            actions['Claiming']['num_actions_against'],
            actions['Claiming']['goals_added_against'],
            actions['Fouling']['num_actions_for'],
            actions['Fouling']['goals_added_for'],
            actions['Fouling']['num_actions_against'],
            actions['Fouling']['goals_added_against'],
            int(season)
        ))
        conn.commit()
    cursor.close()
